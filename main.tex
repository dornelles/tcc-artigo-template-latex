...
\textoapresentacao{
    O presente trabalho será submetido ao Periódico xxxx e segue a normas específicas para essa publicação, que se encontram em anexo. \par
...
\resumoemingles{
    Write here the abstract of the work in English. The abstract must contain
    between 150 and 500 words and present concisely the objectives,
    the methodology, the results and the conclusions of the work.
}
